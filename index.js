const contentLetterSrart_actived = "今天是什么日子？." //Lời mở đầu cho bức thư
const mainContentLetter = "祝 Truc Quynh 生日快乐^^。 新的一年充满欢乐、健康、成功和许多美好的事情。愿你所有的梦想成真，每一天都充满快乐！不要对未来太担心。每一步，无论多么小，都会帮助您找到自己的道路。要有耐心并抓住机会！一定会做到的！" //Nội dung của bức thư

// Gắn 1 đường link ảnh bất kì
let imgStart = document.querySelector(".myAI"); //Hình ảnh xuất hiện trong lời mở đầu của bức thư
imgStart.src = "./img/snapedit_1732025981836.png";

// Gắn 1 link ảnh bất kì
let imgLetter = document.querySelector(".img");
imgLetter.src = "./img/snapedit_1732025997154.png"; //Hình ảnh xuất hiện trong nội dung của bức thư sau khi bức thư được viết ra hết
